// Dafny program KMS_identifier_second_edition.dfy compiled into C#
...
// Command Line Options: c:\Users\Tardi\OneDrive\文档\Dafny-Programs\KMS_identifier_second_edition.dfy /verifyAllModules /compile:1 /spillTargetCode:1 /out:bin\KMS_identifier_second_edition
// KMS_identifier_second_edition.dfy
...
method test3()
{
  ...
  var sum := [""""];
  var y := [1, 2, 3];
  var t := [[3.14, 2.7, 1.41, 1985.44, 100.0, 37.2][..1], [3.14, 2.7, 1.41, 1985.44, 100.0, 37.2][1 .. 1 + 0], [3.14, 2.7, 1.41, 1985.44, 100.0, 37.2][1 + 0 .. 1 + 0 + 3]];
  var sample := ""ab:c"";
  var c := sample[..2];
  var sli := ""abc"";
  var a := ""abcd"";
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      Dafny.ISequence<Dafny.ISequence<char>> _0_s;
      _0_s = Dafny.Sequence<Dafny.ISequence<char>>.FromElements(Dafny.Sequence<char>.FromString("a"));
      Dafny.ISequence<Dafny.ISequence<char>> _1_x;
      _1_x = Dafny.Sequence<Dafny.ISequence<char>>.FromElements(Dafny.Sequence<char>.FromString("b"));
      Dafny.ISequence<Dafny.ISequence<char>> _2_sum;
      _2_sum = Dafny.Sequence<Dafny.ISequence<char>>.FromElements(Dafny.Sequence<char>.FromString(""));
      Dafny.ISequence<BigInteger> _3_y;
      _3_y = Dafny.Sequence<BigInteger>.FromElements(BigInteger.One, new BigInteger(2), new BigInteger(3));
      Dafny.ISequence<Dafny.ISequence<Dafny.BigRational>> _4_t;
      _4_t = Dafny.Sequence<Dafny.ISequence<Dafny.BigRational>>.FromElements((Dafny.Sequence<Dafny.BigRational>.FromElements(new Dafny.BigRational(new BigInteger(314), BigInteger.Parse("100")), new Dafny.BigRational(new BigInteger(27), BigInteger.Parse("10")), new Dafny.BigRational(new BigInteger(141), BigInteger.Parse("100")), new Dafny.BigRational(new BigInteger(198544), BigInteger.Parse("100")), new Dafny.BigRational(BigInteger.Parse("100"), BigInteger.One), new Dafny.BigRational(new BigInteger(372), BigInteger.Parse("10")))).Take(BigInteger.One), (Dafny.Sequence<Dafny.BigRational>.FromElements(new Dafny.BigRational(new BigInteger(314), BigInteger.Parse("100")), new Dafny.BigRational(new BigInteger(27), BigInteger.Parse("10")), new Dafny.BigRational(new BigInteger(141), BigInteger.Parse("100")), new Dafny.BigRational(new BigInteger(198544), BigInteger.Parse("100")), new Dafny.BigRational(BigInteger.Parse("100"), BigInteger.One), new Dafny.BigRational(new BigInteger(372), BigInteger.Parse("10")))).Subsequence(BigInteger.One, (BigInteger.One) + (BigInteger.Zero)), (Dafny.Sequence<Dafny.BigRational>.FromElements(new Dafny.BigRational(new BigInteger(314), BigInteger.Parse("100")), new Dafny.BigRational(new BigInteger(27), BigInteger.Parse("10")), new Dafny.BigRational(new BigInteger(141), BigInteger.Parse("100")), new Dafny.BigRational(new BigInteger(198544), BigInteger.Parse("100")), new Dafny.BigRational(BigInteger.Parse("100"), BigInteger.One), new Dafny.BigRational(new BigInteger(372), BigInteger.Parse("10")))).Subsequence((BigInteger.One) + (BigInteger.Zero), ((BigInteger.One) + (BigInteger.Zero)) + (new BigInteger(3))));
      Dafny.ISequence<char> _5_sample;
      _5_sample = Dafny.Sequence<char>.FromString("ab:c");
      Dafny.ISequence<char> _6_c;
      _6_c = (_5_sample).Take(new BigInteger(2));
      Dafny.ISequence<char> _7_sli;
      _7_sli = Dafny.Sequence<char>.FromString("abc");
      Dafny.ISequence<char> _8_a;
      _8_a = Dafny.Sequence<char>.FromString("abcd");
      Dafny.ISequence<char> _9_b;
      _9_b = Dafny.Sequence<char>.FromString("b");
      Dafny.ISequence<char> _10_f;
      _10_f = Dafny.Sequence<char>.FromElements((_8_a).Select(BigInteger.Zero));
    }
  }
