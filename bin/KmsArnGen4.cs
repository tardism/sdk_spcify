// Dafny program KmsArnGen4.dfy compiled into C#
...
// Command Line Options: c:\Users\Tardi\OneDrive\文档\Dafny-Programs\KmsArnGen4.dfy /spillTargetCode:1 /compile:3 /out:bin\KmsArnGen4
// KmsArnGen4.dfy
...
datatype Result = Success(value: bool) | Failure(error: string)

function method FindNextDelimiter(input: string, delimiter: char, index: nat): (output: nat)
...
function method Join(s: seq<string>, d: char): (output: string)
  requires |s| > 0
  decreases |s|
{
  if |s| == 1 then
...
function method split(s: string, d: char): (output: seq<string>)
  ensures forall o: seq<char> | o in output :: d !in o
  ensures 0 < |output|
  ...
  decreases |s|
{
  if d !in s then
    ...
    var index: nat := FindNextDelimiter(s, d, 0); [s[..index]] + split(s[index + 1..], d)
}
  ...
  decreases a
{
  ...
  |a.account| != 0 &&
  |a.region| != 0 &&
  ((a.resource.rtype == ""key"" && |a.resource.id| != 0) || (a.resource.rtype == ""alias"" && |a.resource.id| != 0))
}
  ...
  decreases a
{
  if KmsArn?(a) == false then
    Result.Failure(""not a KmsArn, due to KmsArn? false"")
  else
    var resBool: bool := a.resource.rtype == ""key"" && |a.resource.id| > 4 && ""mrk-"" < a.resource.id; Result.Success(resBool)
}

function method AwsArn?(s: string): Result
  decreases s
{
  var seqS: seq<string> := split(s, ':');
  if |seqS| != 6 then
    Result.Failure(""not a Arn, due to |seqS| != 6"")
  else
    var seqResource: seq<string> := split(seqS[5], '/'); if |seqResource| != 2 then Result.Failure(""not a Arn, due to |seqResource|!=2"") else Result.Success(true)
}
...
{
  var seqS: seq<string> := split(s, ':');
  var seqResource: seq<string> := split(seqS[5], '/');
  var resource: Resource := Resource(seqResource[0], seqResource[1]);
...
function method AwsKmsMrkArn?(s: string): (result: Result)
  decreases s
{
  var awsArn?: Result := AwsArn?(s);
  if awsArn? == Result.Success(true) then
    var arn: ARN := CreateArn(s);
...
namespace _module {
  ...
  public class Resource : _IResource {
    public readonly Dafny.ISequence<char> _rtype;
    ...
    public _IResource DowncastClone() {
      ...
      return new Resource(_rtype, _id);
    }
    public override bool Equals(object other) {
      var oth = other as Resource;
      return oth != null && object.Equals(this._rtype, oth._rtype) && object.Equals(this._id, oth._id);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._rtype));
    ...
    public override string ToString() {
      ...
      s += "(";
      s += Dafny.Helpers.ToString(this._rtype);
      s += ", ";
  ...
  public class ARN : _IARN {
    ...
    public readonly _IResource _resource;
    ...
    public _IARN DowncastClone() {
      ...
      return new ARN(_arnLiteral, _partition, _service, _region, _account, _resource);
    }
    public override bool Equals(object other) {
  ...
  public interface _IResult {
    ...
    bool is_Failure { get; }
    bool dtor_value { get; }
    Dafny.ISequence<char> dtor_error { get; }
    _IResult DowncastClone();
  }
  public abstract class Result : _IResult {
    public Result() { }
    private static readonly _IResult theDefault = create_Success(false);
    public static _IResult Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_IResult> _TYPE = new Dafny.TypeDescriptor<_IResult>(Result.Default());
    public static Dafny.TypeDescriptor<_IResult> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IResult create_Success(bool @value) {
      return new Result_Success(@value);
    }
    public static _IResult create_Failure(Dafny.ISequence<char> error) {
      return new Result_Failure(error);
    }
    public bool is_Success { get { return this is Result_Success; } }
    public bool is_Failure { get { return this is Result_Failure; } }
    public bool dtor_value {
      get {
        var d = this;
        return ((Result_Success)d)._value;
      }
    }
    public Dafny.ISequence<char> dtor_error {
      get {
        var d = this;
        return ((Result_Failure)d)._error;
      }
    }
    public abstract _IResult DowncastClone();
  }
  public class Result_Success : Result {
    public readonly bool _value;
    public Result_Success(bool @value) {
      this._value = @value;
    }
    public override _IResult DowncastClone() {
      if (this is _IResult dt) { return dt; }
      return new Result_Success(_value);
    }
    public override bool Equals(object other) {
      var oth = other as Result_Success;
  ...
  public class Result_Failure : Result {
    public readonly Dafny.ISequence<char> _error;
    public Result_Failure(Dafny.ISequence<char> error) {
      this._error = error;
    }
    public override _IResult DowncastClone() {
      if (this is _IResult dt) { return dt; }
      return new Result_Failure(_error);
    }
    public override bool Equals(object other) {
      var oth = other as Result_Failure;
  ...
  public partial class __default {
    public static BigInteger FindNextDelimiter(Dafny.ISequence<char> input, char delimiter, BigInteger index)
    {
    TAIL_CALL_START: ;
      if (((input).Select(index)) == (delimiter)) {
        return index;
      } else {
        Dafny.ISequence<char> _in0 = input;
        char _in1 = delimiter;
    ...
    public static Dafny.ISequence<char> Join(Dafny.ISequence<Dafny.ISequence<char>> s, char d)
    {
      Dafny.ISequence<char> _0___accumulator = Dafny.Sequence<char>.FromElements();
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)) == (BigInteger.One)) {
        return Dafny.Sequence<char>.Concat(_0___accumulator, (s).Select(BigInteger.Zero));
      } else {
        _0___accumulator = Dafny.Sequence<char>.Concat(_0___accumulator, Dafny.Sequence<char>.Concat((s).Select(BigInteger.Zero), Dafny.Sequence<char>.FromElements(d)));
        Dafny.ISequence<Dafny.ISequence<char>> _in3 = (s).Drop(BigInteger.One);
        char _in4 = d;
        s = _in3;
        d = _in4;
        goto TAIL_CALL_START;
    ...
    public static Dafny.ISequence<Dafny.ISequence<char>> split(Dafny.ISequence<char> s, char d)
    {
      Dafny.ISequence<Dafny.ISequence<char>> _1___accumulator = Dafny.Sequence<Dafny.ISequence<char>>.FromElements();
    TAIL_CALL_START: ;
      if (!(s).Contains((d))) {
        return Dafny.Sequence<Dafny.ISequence<char>>.Concat(_1___accumulator, Dafny.Sequence<Dafny.ISequence<char>>.FromElements(s));
      } else {
        BigInteger _2_index = __default.FindNextDelimiter(s, d, BigInteger.Zero);
        _1___accumulator = Dafny.Sequence<Dafny.ISequence<char>>.Concat(_1___accumulator, Dafny.Sequence<Dafny.ISequence<char>>.FromElements((s).Take(_2_index)));
        Dafny.ISequence<char> _in5 = (s).Drop((_2_index) + (BigInteger.One));
        char _in6 = d;
        s = _in5;
        d = _in6;
        goto TAIL_CALL_START;
    ...
    public static bool KmsArn_q(_IARN a) {
      return (((((((a).dtor_arnLiteral).Equals((Dafny.Sequence<char>.FromString("arn")))) && ((new BigInteger(((a).dtor_partition).Count)).Sign != 0)) && (((a).dtor_service).Equals((Dafny.Sequence<char>.FromString("kms"))))) && ((new BigInteger(((a).dtor_account).Count)).Sign != 0)) && ((new BigInteger(((a).dtor_region).Count)).Sign != 0)) && ((((((a).dtor_resource).dtor_rtype).Equals((Dafny.Sequence<char>.FromString("key")))) && ((new BigInteger((((a).dtor_resource).dtor_id).Count)).Sign != 0)) || (((((a).dtor_resource).dtor_rtype).Equals((Dafny.Sequence<char>.FromString("alias")))) && ((new BigInteger((((a).dtor_resource).dtor_id).Count)).Sign != 0)));
    }
    public static _IResult AwsKmsMrkArn__helper(_IARN a) {
      if ((__default.KmsArn_q(a)) == (false)) {
        return Result.create_Failure(Dafny.Sequence<char>.FromString("not a KmsArn, due to KmsArn? false"));
      } else {
        bool _3_resBool = (((((a).dtor_resource).dtor_rtype).Equals((Dafny.Sequence<char>.FromString("key")))) && ((new BigInteger((((a).dtor_resource).dtor_id).Count)) > (new BigInteger(4)))) && (Dafny.Sequence<char>.IsProperPrefixOf(Dafny.Sequence<char>.FromString("mrk-"), ((a).dtor_resource).dtor_id));
        return Result.create_Success(_3_resBool);
      }
    }
    public static _IResult AwsArn_q(Dafny.ISequence<char> s) {
      Dafny.ISequence<Dafny.ISequence<char>> _4_seqS = __default.split(s, ':');
      if ((new BigInteger((_4_seqS).Count)) != (new BigInteger(6))) {
        return Result.create_Failure(Dafny.Sequence<char>.FromString("not a Arn, due to |seqS| != 6"));
      } else {
        Dafny.ISequence<Dafny.ISequence<char>> _5_seqResource = __default.split((_4_seqS).Select(new BigInteger(5)), '/');
        if ((new BigInteger((_5_seqResource).Count)) != (new BigInteger(2))) {
          return Result.create_Failure(Dafny.Sequence<char>.FromString("not a Arn, due to |seqResource|!=2"));
        } else {
          return Result.create_Success(true);
        }
      }
    }
    public static _IARN CreateArn(Dafny.ISequence<char> s) {
      Dafny.ISequence<Dafny.ISequence<char>> _6_seqS = __default.split(s, ':');
      Dafny.ISequence<Dafny.ISequence<char>> _7_seqResource = __default.split((_6_seqS).Select(new BigInteger(5)), '/');
      _IResource _8_resource = Resource.create((_7_seqResource).Select(BigInteger.Zero), (_7_seqResource).Select(BigInteger.One));
      return ARN.create((_6_seqS).Select(BigInteger.Zero), (_6_seqS).Select(BigInteger.One), (_6_seqS).Select(new BigInteger(2)), (_6_seqS).Select(new BigInteger(3)), (_6_seqS).Select(new BigInteger(4)), _8_resource);
    }
    public static _IResult AwsKmsMrkArn_q(Dafny.ISequence<char> s) {
      _IResult _9_awsArn_q = __default.AwsArn_q(s);
      if (object.Equals(_9_awsArn_q, Result.create_Success(true))) {
        _IARN _10_arn = __default.CreateArn(s);
        return __default.AwsKmsMrkArn__helper(_10_arn);
      } else {
        return _9_awsArn_q;
      }
    }
    public static _IResult AwsKmsMrkArnIdentifier_q(Dafny.ISequence<char> s) {
      if (Dafny.Sequence<char>.IsProperPrefixOf(Dafny.Sequence<char>.FromString("arn:"), s)) {
        return __default.AwsKmsMrkArn_q(s);
      } else {
        return Result.create_Success(Dafny.Sequence<char>.IsProperPrefixOf(Dafny.Sequence<char>.FromString("mrk-"), s));
      }
    }
  }
