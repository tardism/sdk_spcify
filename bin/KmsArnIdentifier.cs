// Dafny program KmsArnIdentifier.dfy compiled into C#
...
// Command Line Options: c:\Users\Tardi\OneDrive\文档\Dafny-Programs\KmsArnIdentifier.dfy /verifyAllModules /compile:1 /spillTargetCode:1 /out:bin\KmsArnIdentifier
// KmsArnIdentifier.dfy
...
namespace _module {
  ...
  public partial class ArnString {
    private static readonly Dafny.ISequence<char> Witness = Dafny.Sequence<char>.FromString("arn");
    public static Dafny.ISequence<char> Default() {
      return Witness;
    }
    private static readonly Dafny.TypeDescriptor<Dafny.ISequence<char>> _TYPE = new Dafny.TypeDescriptor<Dafny.ISequence<char>>(ArnString.Default());
  ...
  public interface _IKmsArnDatatype {
    bool is_KmsArnDatatype { get; }
    Dafny.ISequence<char> dtor_arnLiteral { get; }
    Dafny.ISequence<char> dtor_partition { get; }
    Dafny.ISequence<char> dtor_service { get; }
    Dafny.ISequence<char> dtor_region { get; }
  ...
  public class KmsArnDatatype : _IKmsArnDatatype {
    ...
    public _IKmsArnDatatype DowncastClone() {
      if (this is _IKmsArnDatatype dt) { return dt; }
      return new KmsArnDatatype(arnLiteral, partition, service, region, account, resource);
    }
    public override bool Equals(object other) {
      var oth = other as KmsArnDatatype;
      return oth != null && object.Equals(this.arnLiteral, oth.arnLiteral) && object.Equals(this.partition, oth.partition) && object.Equals(this.service, oth.service) && object.Equals(this.region, oth.region) && object.Equals(this.account, oth.account) && object.Equals(this.resource, oth.resource);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "KmsArnDatatype.KmsArnDatatype";
      s += "(";
      s += Dafny.Helpers.ToString(this.arnLiteral);
      s += ", ";
      s += Dafny.Helpers.ToString(this.partition);
    ...
    private static readonly Dafny.TypeDescriptor<_IKmsArnDatatype> _TYPE = new Dafny.TypeDescriptor<_IKmsArnDatatype>(KmsArnDatatype.Default());
