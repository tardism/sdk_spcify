...
// Command Line Options: c:\Users\Tardi\OneDrive\文档\Dafny-Programs\test.dfy /verifyAllModules /compile:1 /spillTargetCode:1 /out:bin\test
// test.dfy
...
datatype ARN = ARN(l: string, p: string, s: string, a: string, r: string)
...
namespace _module {
  ...
  public interface _IResult<T> {
    ...
    bool IsFailure();
    _IResult<__U> PropagateFailure<__U>();
    T Extract();
  }
  public abstract class Result<T> : _IResult<T> {
    public Result() { }
    public static _IResult<T> Default() {
      return create_Failure(Dafny.Sequence<char>.Empty);
    }
    ...
    public static _IResult<T> create_Failure(Dafny.ISequence<char> error) {
    ...
    public _IResult<__U> PropagateFailure<__U>() {
      return Result<__U>.create_Failure((this).dtor_error);
    }
    public T Extract() {
  ...
  public class Result_Success<T> : Result<T> {
    ...
    public override _IResult<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      ...
      return new Result_Success<__T>(converter0(@value));
    }
    public override bool Equals(object other) {
  ...
  public class Result_Failure<T> : Result<T> {
    public readonly Dafny.ISequence<char> error;
    public Result_Failure(Dafny.ISequence<char> error) {
      this.error = error;
    }
    public override _IResult<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _IResult<__T> dt) { return dt; }
      return new Result_Failure<__T>(error);
    }
    public override bool Equals(object other) {
  ...
  public interface _IARN {
    bool is_ARN { get; }
    Dafny.ISequence<char> dtor_l { get; }
    Dafny.ISequence<char> dtor_p { get; }
    Dafny.ISequence<char> dtor_s { get; }
    Dafny.ISequence<char> dtor_a { get; }
    Dafny.ISequence<char> dtor_r { get; }
    _IARN DowncastClone();
  }
  public class ARN : _IARN {
    public readonly Dafny.ISequence<char> l;
    public readonly Dafny.ISequence<char> p;
    public readonly Dafny.ISequence<char> s;
    public readonly Dafny.ISequence<char> a;
    public readonly Dafny.ISequence<char> r;
    public ARN(Dafny.ISequence<char> l, Dafny.ISequence<char> p, Dafny.ISequence<char> s, Dafny.ISequence<char> a, Dafny.ISequence<char> r) {
      this.l = l;
      this.p = p;
      this.s = s;
      this.a = a;
    ...
    public _IARN DowncastClone() {
      ...
      return new ARN(l, p, s, a, r);
    }
    public override bool Equals(object other) {
      var oth = other as ARN;
      return oth != null && object.Equals(this.l, oth.l) && object.Equals(this.p, oth.p) && object.Equals(this.s, oth.s) && object.Equals(this.a, oth.a) && object.Equals(this.r, oth.r);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
    ...
    public override string ToString() {
      string ss = "ARN.ARN";
      ss += "(";
      ss += Dafny.Helpers.ToString(this.l);
      ss += ", ";
      ss += Dafny.Helpers.ToString(this.p);
      ss += ", ";
      ss += Dafny.Helpers.ToString(this.s);
      ss += ", ";
      ss += Dafny.Helpers.ToString(this.a);
      ss += ", ";
      ss += Dafny.Helpers.ToString(this.r);
      ss += ")";
      return ss;
    }
    private static readonly _IARN theDefault = create(Dafny.Sequence<char>.Empty, Dafny.Sequence<char>.Empty, Dafny.Sequence<char>.Empty, Dafny.Sequence<char>.Empty, Dafny.Sequence<char>.Empty);
    ...
    public static _IARN create(Dafny.ISequence<char> l, Dafny.ISequence<char> p, Dafny.ISequence<char> s, Dafny.ISequence<char> a, Dafny.ISequence<char> r) {
      return new ARN(l, p, s, a, r);
    }
    public bool is_ARN { get { return true; } }
    public Dafny.ISequence<char> dtor_l {
      get {
        return this.l;
      }
    }
    public Dafny.ISequence<char> dtor_p {
      get {
        return this.p;
      }
    }
    ...
    public Dafny.ISequence<char> dtor_a {
      get {
        return this.a;
      }
    }
  ...
  public partial class __default {
    /* Compilation error: Function _module._default.split has no body */
    public static _IResult<Dafny.ISequence<Dafny.ISequence<char>>> F(Dafny.ISequence<char> s) {
      Dafny.ISequence<Dafny.ISequence<char>> _0_test = __default.split(s);
      if ((new BigInteger((_0_test).Count)) == (new BigInteger(5))) {
        return Result<Dafny.ISequence<Dafny.ISequence<char>>>.create_Success(_0_test);
      } else {
        return Result<Dafny.ISequence<Dafny.ISequence<char>>>.create_Failure(Dafny.Sequence<char>.FromString("did not split to 5"));
      }
    }
    public static _IResult<_IARN> use(Dafny.ISequence<char> s) {
      _IResult<Dafny.ISequence<Dafny.ISequence<char>>> _1_valueOrError0 = __default.F(s);
